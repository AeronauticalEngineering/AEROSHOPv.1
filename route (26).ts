...
import { LineAdminUser, ShippingConditionType, ShippingOption, StoreSettings } from "@/types/store";
import {
    Save,
    Store,
    Truck,
...
export default function AdminSettingsPage() {
    ...
    const [activeTab, setActiveTab] = useState<'store' | 'payment' | 'firestore' | 'shipping' | 'line'>('store');
