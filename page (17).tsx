...
import { Search, Eye, Truck, CheckCircle, XCircle, Clock, Package, Trash2, X, ChevronLeft, ChevronRight, ShoppingBag, Loader2, User, MapPin, CreditCard, RotateCcw, CircleAlert } from "lucide-react";
                                    ...
                                    {refundSummary.length > 0 && (
                                        <section className="rounded-xl border border-orange-100 bg-white overflow-hidden">
                                            ...
                                            <div className="divide-y divide-orange-50">
                                                {refundSummary.map(({ item, status, amount }, idx) => (
                                                    <div key={`${item.productId}-${idx}`} className="flex items-start justify-between gap-3 px-4 py-3">
                                                        <div className="min-w-0">
                                                            <div className="flex flex-wrap items-center gap-2">
                                                                <p className="text-sm font-semibold text-gray-900">{item.productName}</p>
