...
import { buildSlipResultFlexMessage } from "@/lib/line/flex";
                                            ...
                                            {item.bundleItems && item.bundleItems.length > 0 && (
                                                <div className="mt-1 space-y-0.5 rounded-lg bg-slate-50 px-2 py-1.5">
                                                    {item.bundleItems.map((bundleItem) => (
                                                        <div key={bundleItem.id} className="text-[10px] text-slate-500">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        {(!slipDocId || slipStatus.status !== 'verified') && (
                                            <button
                                                ...
                                                className="inline-flex items-center gap-1.5 rounded-lg bg-orange-500 px-3 py-2 text-[11px] font-bold text-white shadow-md shadow-orange-500/20 transition hover:bg-orange-600"
                                            >
                                                <UploadCloud size={13} />
                                                เปลี่ยน
                                            </button>
